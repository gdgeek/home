export default {
  ...
  devlog: {
    ...
    subtitle: 'Public engineering progress, product iteration notes, and release stories from the XR UGC platform.',
    listLabel: 'Development log list',
    readMore: 'Read more →',
    backHome: 'Back to home',
    backList: 'Back to dev log',
    detailNavLabel: 'Development log navigation',
    sourceLabel: 'Source:',
    emptyTitle: 'No public entries yet',
    emptyBody: 'CI only publishes work-log entries that are explicitly marked with publish: true.',
    notFoundTitle: 'Entry not found',
    notFoundBody: 'This entry may not be public yet, or it may have been removed from the published list.',
  },
  login: {
