export default {
  ...
  devlog: {
    kicker: 'Build Notes',
    title: '開発ログ',
    subtitle: 'XR UGC プラットフォームの公開可能な開発進捗、製品改善、リリース記録です。',
    listLabel: '開発ログ一覧',
    readMore: '詳しく読む →',
    backHome: 'ホームへ戻る',
    backList: '開発ログへ戻る',
    detailNavLabel: '開発ログナビゲーション',
    sourceLabel: 'ソース：',
    emptyTitle: '公開ログはまだありません',
    emptyBody: 'CI は work-log 内で publish: true と明示された項目だけを公開します。',
    notFoundTitle: 'ログが見つかりません',
    notFoundBody: 'このログはまだ公開されていないか、公開リストから削除された可能性があります。',
  },
  login: {
    title: "{brand} にログイン",
    username: "ユーザー名",
