export default {
  ...
  devlog: {
    kicker: 'Build Notes',
    title: '開發日誌',
    subtitle: '記錄 XR UGC 平台公開可見的工程進展、產品迭代和發布說明。',
    listLabel: '開發日誌列表',
    readMore: '閱讀詳情 →',
    backHome: '返回首頁',
    backList: '返回開發日誌',
    detailNavLabel: '開發日誌導覽',
    sourceLabel: '來源：',
    emptyTitle: '尚未有公開日誌',
    emptyBody: 'CI 只會發布 work-log 中明確標記為 publish: true 的條目。',
    notFoundTitle: '找不到這篇日誌',
    notFoundBody: '這篇日誌可能尚未公開，或已從發布列表中移除。',
  },
  login: {
    title: "平台登錄",
    username: "用戶名",
