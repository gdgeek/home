 ...
 */
export const wordpressHttpClient: HttpClient =
  createHttpClient(wordpressApiInstance);

/**
 * 后端API HTTP客户端
 */
export const backendHttpClient: HttpClient =
  createHttpClient(backendApiInstance);
