    ...
    <header class="mp-nav" :class="{ 'mp-nav--scrolled': navScrolled }">
      <div class="mp-nav__inner">
        ...
        <div class="mp-nav__actions">
          ...
          <button class="mp-btn mp-btn--ghost" @click="handleOpenLogin">登录</button>
          <button class="mp-btn mp-btn--cta" @click="handleOpenLogin">免费试用</button>
      ...
      <Transition name="mobile-menu">
        <div v-if="mobileMenuOpen" class="mp-nav__mobile">
          ...
          <button class="mp-btn mp-btn--cta mp-btn--block" @click="handleOpenLogin">免费试用</button>
        </div>
      </Transition>
    </header>
